...
**PathFinder@Heinz** is a rebuilt, more advanced version of an earlier project, **PathFinder@CISE** - https://github.com/ShiaAnanth/PathFinder-RAG, which I originally built to help prospective students explore programs in the College of Integrated Science and Engineering (CISE) at James Madison University (JMU). This version uses a different, more sophisticated stack (Qdrant, Docker, OpenAI embeddings) and adds a rigorous evaluation layer. 
